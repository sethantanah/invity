...
//   actionCell.appendChild(document.createTextNode(" "));
  ...
  // WhatsApp Button
  const whatsappMessage = `From the family of the Kwabi Sarpong's, we would like to thank you all for your unwavering support and prayers to make our day a success. May Jehovah God continually bless you all. Num. 6:24-26`;
  ...
  // SMS Button
  const smsMessage = `From the family of the Kwabi Sarpong's, we would like to thank you all for your unwavering support and prayers to make our day a success. May Jehovah God continually bless you all. Num. 6:24-26`;
  const smsLink = document.createElement("a");
  smsLink.href = `sms:${friend.phone}?body=${encodeURIComponent(smsMessage)}`; // SMS share link
  smsLink.className = "bg-blue-500 text-white py-1 px-2 rounded hover:bg-blue-600";
